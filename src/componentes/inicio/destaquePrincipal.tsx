...
const images = [
  '/images/WhatsApp_Image_2026-05-10_at_17.20.42-removebg-preview.png',
  '/images/WhatsApp_Image_2026-05-10_at_17.28.53-removebg-preview.png',
  '/images/WhatsApp_Image_2026-05-10_at_17.28.59-removebg-preview.png'
];
      ...
      <div className="container mx-auto px-4 py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10 text-center lg:text-left">
            ...
            <div className="inline-flex items-start md:items-center gap-2 bg-white/80 backdrop-blur-sm rounded-2xl px-5 py-3 mb-8 shadow-soft animate-fade-in border border-primary/20">
              ...
              <span className="text-sm font-medium text-foreground leading-snug">
                <strong className="text-primary mr-1">Especial Dia dos Namorados 2026:</strong>
                Presentes personalizados para celebrar o seu amor!
              </span>
            </div>
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in leading-tight" style={{ animationDelay: '0.1s' }}>
              <span style={{ color: '#e11d48' }}>Um Dia dos Namorados <br className="md:hidden" /> com Paixão</span>
              <br className="hidden md:block" />
              <br className="md:hidden" />
              <span className="text-primary">e muito carinho!</span>
            </h1>
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-lg mx-auto lg:mx-0 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              De álbuns de fotos e caixas surpresa a mimos personalizados. Sua papelaria romântica para eternizar momentos a dois.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <ButtonColorful asChild className="h-14 px-8 text-xl">
                <Link to="/catalogo?categoria=dia-dos-namorados" className="gap-2">
                  <span>Ver Coleção de Amor</span>
          ...
          <div className="relative animate-fade-in lg:animate-scale-in" style={{ animationDelay: '0.2s' }}>
            <div className="relative aspect-square scale-110 lg:scale-125">
