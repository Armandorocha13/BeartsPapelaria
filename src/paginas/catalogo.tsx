...
const subcategoriesList: Record<string, { id: string, name: string, image?: string, images?: string[] }[]> = {
  ...
  'dia-dos-namorados': [
    ...
    casamento: [
      ...
      { id: 'site-dos-noivos', name: 'Site dos Noivos', image: '/images/site noivos.jpeg' },
      { id: 'monograma', name: 'Monograma', image: '/images/monograma.jpeg' },
      { id: 'identidade-visual', name: 'Identidade Visual', image: '/images/id visual.jpeg' },
