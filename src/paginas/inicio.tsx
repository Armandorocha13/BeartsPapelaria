...
const Index = () => {
  const featuredProducts = products.filter(p => p.category === 'dia-dos-namorados').slice(0, 8);
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Confira nossa coleção especial de Dia dos Namorados
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
            Pronto para <span style={{ color: '#e11d48' }}>presentear seu amor</span>?
          </h2>
          ...
          <ButtonColorful asChild className="h-14 px-8 text-lg">
            <Link to="/catalogo?categoria=dia-dos-namorados">
              <span>Explorar Catálogo de Amor</span>
