...
export const products: Product[] = [
  ...
  {
    id: 157,
    name: 'Buquê de Bombom',
    description: 'Lindo buquê pequeno personalizado contendo 3 bombons. Um mimo delicioso!',
    price: 10.00,
    category: 'dia-das-maes',
    subcategory: 'buques',
    image: '/images/WhatsApp Image 2026-04-06 at 14.53.35.jpeg',
    isNew: true,
    noPaper: true,
  },
  {
    id: 158,
    name: 'Buquê de Borboletas (Dia das Mães)',
    description: 'Buquê iluminado com borboletas e 3 fotos polaroides inclusas.',
    price: 55.00,
    category: 'dia-das-maes',
    subcategory: 'buques',
    image: imgBuqueBorboletas,
