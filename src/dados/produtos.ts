...
export const products: Product[] = [
  {
    id: 901,
    name: 'Topper para doces',
    description: 'Kit com 10 toppers personalizados para doces juninos.',
    price: 10.00,
    category: 'festa-junina',
    subcategory: 'toppers',
    image: '/images/1 junina.jpeg',
    isNew: true,
    variations: [
      { name: 'Mini', price: 10.00 },
      { name: 'Médio', price: 16.00 },
      { name: 'Grande', price: 22.00 },
    ],
  },
  {
    id: 902,
    name: 'Toppers para salgado',
    description: 'Kit com 10 toppers personalizados para salgados juninos.',
    price: 15.00,
    category: 'festa-junina',
    subcategory: 'toppers',
    image: '/images/1 junina.jpeg',
    isNew: true,
    variations: [
      { name: 'Mini', price: 15.00 },
      { name: 'Médio', price: 21.00 },
      { name: 'Grande', price: 27.00 },
    ],
  },
  {
    id: 906,
    name: 'Tags Juninas',
    description: 'Tags personalizadas para o seu arraiá. Selecione o tamanho e acabamento ideais!',
    price: 0.50,
    category: 'festa-junina',
    subcategory: 'tags',
    image: '/images/5 junina.jpeg',
    isNew: true,
    variations: [
      { name: 'Tamanho 3x3', price: 0.50 },
      { name: 'Tamanho 4x4', price: 0.90 },
      { name: 'Tamanho 5x5', price: 1.10 },
      { name: 'Tamanho 6x6', price: 1.50 },
    ],
    secondaryVariationTitle: 'Adesão:',
    secondaryVariations: [
      { name: 'Sem Adesivo', price: 0 },
      { name: 'Com Adesivo', price: 0.25 },
    ],
    tertiaryVariationTitle: 'Formato e Furação:',
    tertiaryVariations: [
      { name: 'Redonda - Com Furo', price: 0 },
      { name: 'Redonda - Sem Furo', price: 0 },
      { name: 'Quadrada - Com Furo', price: 0 },
      { name: 'Quadrada - Sem Furo', price: 0 },
      { name: 'Retangular - Com Furo', price: 0 },
      { name: 'Retangular - Sem Furo', price: 0 },
    ],
  },
  {
    id: 911,
    name: 'Painel Lambe Lambe Junino',
    description: 'Painel decorativo estilo lambe lambe para o seu arraiá. Obs: Montagem não inclusa.',
    price: 45.00,
    category: 'festa-junina',
    subcategory: 'lambe-lambe',
    image: '/images/10 junina.jpeg',
    isNew: true,
    variations: [
    ...
    secondaryVariations: [
      { name: 'Glossy Adesivo', price: 0 },
      { name: 'Glossy', price: 0 },
      { name: 'Matte', price: 0 },
      { name: 'Ofício', price: -10.00 },
      { name: 'Offset', price: 0 },
    ],
  },
  {
    id: 910,
    name: 'Kit de Display Junino',
    description: 'Displays de mesa em papel fotográfico para decorar seu arraiá. Escolha a quantidade e o tema!',
    price: 10.00,
    category: 'festa-junina',
    subcategory: 'displays-mesa',
    image: '/images/9 junina.jpeg',
    isNew: true,
    variations: [
      { name: 'Kit com 2 unidades', price: 10.00 },
      { name: 'Kit com 5 unidades', price: 23.00 },
    ],
    secondaryVariationTitle: 'Escolha o Tema:',
    secondaryVariations: [
      { name: 'Milho', price: 0 },
      { name: 'Caipira (Menino)', price: 0 },
      { name: 'Caipira (Menina)', price: 0 },
      { name: 'Fogueira', price: 0 },
      { name: 'Sanfona', price: 0 },
      { name: 'Balão', price: 0 },
    ],
  },
  {
    ...
    description: 'Bandeirolas personalizadas para o seu arraiá. Valor a partir de 1,5m de cordão.',
    price: 20.00,
    category: 'festa-junina',
    subcategory: 'bandeirolas-personalizadas',
    image: '/images/8 junina.jpeg',
    isNew: true,
    variations: [
      { name: 'Varal 1,5 metros', price: 20.00 },
      { name: 'Varal 2,0 metros', price: 28.00 },
      { name: 'Varal 3,0 metros', price: 40.00 },
    ],
    secondaryVariationTitle: 'Tipo de Papel:',
    secondaryVariations: [
      { name: 'Offset (Fosco)', price: 0 },
      { name: 'Glossy (Brilho)', price: 5.00 },
    ],
  },
  {
    id: 908,
    name: 'Sacolinha Junina',
    description: 'Sacolinha personalizada para o seu arraiá. Ideal para lembrancinhas e doces típicos.',
    price: 2.50,
    category: 'festa-junina',
    subcategory: 'sacolinhas',
    image: '/images/7 junina.jpeg',
    isNew: true,
    variations: [
      { name: 'PP', price: 2.50 },
      { name: 'P', price: 3.50 },
  ...
  {
    id: 907,
    name: 'Kit Correio Elegante',
    description: '20 mensagens personalizadas para animar o seu correio elegante.',
    price: 15.00,
    category: 'festa-junina',
    subcategory: 'kit-correio-elegante',
    image: '/images/6 junina.jpeg',
    isNew: true,
  },
  {
    id: 905,
    name: 'Centro de Mesa Junino',
    description: 'Personalize o centro de mesa do seu arraiá! Selecione o modelo e faça seu orçamento agora.',
    price: 0,
    category: 'festa-junina',
    subcategory: 'centro-mesa',
    image: '/images/4 junina.jpeg',
    isNew: true,
    secondaryVariationTitle: 'Solicitar via WhatsApp',
    secondaryVariations: [
      { name: 'Falar com Atendimento', price: 0 },
    ],
  },
  {
    id: 904,
    name: 'Caixinhas Personalizadas',
    description: 'Caixinhas personalizadas para sua festa junina. Escolha seu modelo favorito!',
    price: 3.50,
    category: 'festa-junina',
    subcategory: 'caixinhas-personalizadas',
    image: '/images/3 junina.jpeg',
    isNew: true,
    variations: [
      { name: 'Milk', price: 3.50 },
      { name: 'Bandeira', price: 3.50 },
      { name: 'Pirâmide', price: 3.50 },
      { name: 'Sushi', price: 3.50 },
      { name: 'Maleta', price: 3.50 },
    ],
    secondaryVariationTitle: 'Cor da Caixa:',
    secondaryVariations: [
      { name: 'Junina Rosa', price: 0 },
      { name: 'Junina Azul', price: 0 },
      { name: 'Neutro', price: 0 },
    ],
  },
  {
    ...
    description: 'Kit com 10 forminhas personalizadas para doces.',
    price: 18.00,
    category: 'festa-junina',
    subcategory: 'forminhas-personalizadas',
    image: '/images/2 junina.jpeg',
    isNew: true,
    secondaryVariationTitle: 'Tema da Forminha:',
    secondaryVariations: [
      { name: 'Milho', price: 0 },
      { name: 'Fogueira', price: 0 },
      { name: 'Barraca do Beijinho', price: 0 },
      { name: 'Mini Caixote', price: 0 },
    ],
  },
  {
    id: 200,
