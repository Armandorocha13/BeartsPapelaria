...
export interface Product {
  ...
  tertiaryVariations?: { name: string; price: number }[];
  tertiaryVariationTitle?: string;
  minQuantity?: number;
  noPaper?: boolean;
...
export const products: Product[] = [
  {
    id: 901,
    name: 'Caixa Envelope Dia dos Pais',
    description: 'Caixa com itens sortidos.',
    price: 35.00,
    category: 'dia-dos-pais',
    subcategory: 'caixa-envelope',
    image: '/images/envelope pai.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: 'Tamanho P', price: 35.00 },
      { name: 'Tamanho M', price: 50.00 },
      { name: 'Tamanho G', price: 70.00 },
    ],
    secondaryVariationTitle: 'Cartão:',
    secondaryVariations: [
      { name: 'Sem cartão personalizado', price: 0 },
      { name: 'Com cartão personalizado', price: 3.00 },
    ],
  },
  {
    id: 902,
    name: 'Caixa Camisa Dia dos Pais',
    description: 'Caixinha com Ferrero Rocher.',
    price: 25.00,
    category: 'dia-dos-pais',
    subcategory: 'caixa-camisa',
    image: '/images/camisa pai.jpeg',
    isNew: true,
    noPaper: true,
    secondaryVariationTitle: 'Time de Futebol:',
    secondaryVariations: [
      { name: 'Flamengo', price: 0 },
      { name: 'Vasco', price: 0 },
      { name: 'Botafogo', price: 0 },
      { name: 'Fluminense', price: 0 },
      { name: 'Outro (informar na descrição)', price: 0 },
    ],
  },
  {
    id: 903,
    name: 'Chaveiro Personalizado Dia dos Pais',
    description: 'Chaveiro acrílico 3x4 personalizado',
    price: 12.00,
    category: 'dia-dos-pais',
    subcategory: 'chaveiro-personalizado',
    image: '/images/chaveiro pai.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: 'Chaveiro comum', price: 12.00 },
      { name: 'Chaveiro abridor', price: 15.00 },
    ],
  },
  {
    id: 904,
    name: 'Polaroide Personalizada Dia dos Pais',
    description: 'Polaroide Retro personalizado + caixinha',
    price: 15.00,
    category: 'dia-dos-pais',
    subcategory: 'polaroide-personalizada',
    image: '/images/polaroide pai.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: 'Kit com 9 fotos', price: 15.00 },
      { name: 'Kit com 18 fotos', price: 25.00 },
    ],
  },
  {
    id: 905,
    name: 'Caixa Cenário Dia dos Pais',
    description: 'caixa com itens sortidos personalizados',
    price: 30.00,
    category: 'dia-dos-pais',
    subcategory: 'caixa-cenario',
    image: '/images/cenario pai.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: 'Tamanho P', price: 30.00 },
      { name: 'Tamanho M', price: 45.00 },
      { name: 'Tamanho G', price: 70.00 },
    ],
  },
  {
    id: 906,
    name: 'Álbum de Figurinhas Dia dos Pais',
    description: 'album personalizado dia dos pais com figurinhas autocolante',
    price: 65.00,
    category: 'dia-dos-pais',
    subcategory: 'album-figurinhas',
    image: '/images/album pai.jpeg',
    isNew: true,
    noPaper: true,
  },
  {
    id: 907,
    name: 'Quadro Personalizado Dia dos Pais',
    description: 'Quadro decorativo com moldura personalizado com fotos, datas especiais ou frases marcantes para homenagear o seu herói.',
    price: 25.00,
    category: 'dia-dos-pais',
    subcategory: 'quadro-personalizado',
    image: '/images/quadro pai.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: '10x15 - Com Moldura', price: 25.00 },
      { name: '15x20 - Com Moldura', price: 40.00 },
      { name: '21x29 - Com Moldura', price: 55.00 },
    ],
  },
  {
    id: 908,
    name: 'Caneca Acrílica Dia dos Pais',
    description: 'Caneca acrílica personalizada com arte especial do Dia dos Pais e interior colorido.',
    price: 25.00,
    category: 'dia-dos-pais',
    subcategory: 'caneca-acrilico',
    image: '/images/caneca pai.jpeg',
    isNew: true,
    noPaper: true,
    secondaryVariationTitle: 'Cor Interna:',
    secondaryVariations: [
      { name: 'Azul', price: 0 },
      { name: 'Preto', price: 0 },
      { name: 'Branco', price: 0 },
  ...
  {
    id: 909,
    name: 'Bebida Personalizada Dia dos Pais',
    description: 'Bebida com rótulo personalizado para presentear seu pai.',
    price: 15.00,
    category: 'dia-dos-pais',
    subcategory: 'bebida-personalizada',
    image: '/images/vinho pai.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: 'Coca-Cola', price: 15.00 },
      { name: 'Cerveja Long Neck', price: 18.00 },
      { name: 'Vinho', price: 80.00 },
    ],
  },
  {
    id: 910,
    name: 'Jornal Personalizado Dia dos Pais',
    description: 'Jornal com notícias divertidas sobre o seu pai.',
    price: 25.00,
    category: 'dia-dos-pais',
    subcategory: 'jornal-personalizado',
    image: '/images/jornal pai.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: '2 Páginas', price: 25.00 },
      { name: '4 Páginas', price: 35.00 },
    ],
  },
  {
    id: 911,
    name: 'Carteira Personalizada',
    description: 'Carteira slim personalizada, prática e ideal para lembrancinhas corporativas de Dia dos Pais.',
    price: 15.00,
    category: 'dia-dos-pais',
    subcategory: 'lembrancas-corporativas',
    image: '/images/carteira pai.jpeg',
    isNew: true,
    noPaper: true,
  },
  {
    id: 912,
    name: 'Pente Personalizado',
    description: 'Pente de plástico compacto personalizado, perfeito para brindes corporativos.',
    price: 5.00,
    category: 'dia-dos-pais',
    subcategory: 'lembrancas-corporativas',
    image: '/images/pente pai.jpeg',
    isNew: true,
    noPaper: true,
  },
  {
    id: 913,
    name: 'Cortador de Unha Personalizado',
    description: 'Cortador de unha personalizado de metal com capa protetora.',
    price: 7.00,
    category: 'dia-dos-pais',
    subcategory: 'lembrancas-corporativas',
    image: '/images/cortador pai.jpeg',
    isNew: true,
    noPaper: true,
  },
  {
    id: 914,
    name: 'Mini Trena Personalizada',
    description: 'Mini trena personalizada de 1 metro em formato chaveiro.',
    price: 12.00,
    category: 'dia-dos-pais',
    subcategory: 'lembrancas-corporativas',
    image: '/images/trena pai.jpeg',
    isNew: true,
    noPaper: true,
  },
  {
  ...
  {
    id: 1001,
    name: 'Marca Páginas Magnético',
    description: 'Marca páginas magnético personalizado em qualquer tema',
    price: 5.00,
    category: 'outros',
    subcategory: 'marca-pagina-magnetico',
    image: '/images/marca pagina.jpeg',
    isNew: true,
    noPaper: true,
    variations: [
      { name: 'Unidade', price: 5.00 },
      { name: 'Trio', price: 12.00 },
    ],
  },
  {
    id: 27,
  ...
  },
  {
    ...
    noPaper: true,
    variations: [
      { name: 'Tamanho P', price: 28.00 },
      { name: 'Tamanho M', price: 37.00 },
      { name: 'Tamanho G', price: 80.00 },
    ],
  },
  {
    id: 222,
  ...
  },
  {
    id: 234,
    name: 'Uno +18',
    description: 'nesse jogo ninguem sai perdendo',
    price: 55.00,
    category: 'dia-dos-namorados',
    subcategory: 'uno-18',
    image: '/images/WhatsApp Image 2026-05-28 at 10.53.04.jpeg',
    isNew: true,
    noPaper: true,
  },
  {
