      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">
            Explore por <span style={{ color: '#E697b4' }}>Categoria</span>
          </h2>
            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="flex flex-col items-center text-center gap-3">
                  <div className="w-14 h-14 rounded-2xl bg-accent flex items-center justify-center group-hover:bg-[#E697b4] group-hover:shadow-button transition-all duration-300">
